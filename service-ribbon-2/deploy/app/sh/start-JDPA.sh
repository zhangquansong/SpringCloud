#!/bin/sh
#应用信息
API_NAME=service-ribbon-2-0.0.1-SNAPSHOT
...
export CATALINA_HOME=/opt/miaolicai/service-ribbon-2/
export LOG_HOME=/opt/miaolicai/service-ribbon-2/logs/log.out
