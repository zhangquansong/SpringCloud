#!/bin/sh
#应用信息
API_NAME=eureka-server2-0.0.1-SNAPSHOT
...
export CATALINA_HOME=/usr/local/java/project/eureka-server2/
export LOG_HOME=/usr/local/java/project/eureka-server2/logs/log.out
